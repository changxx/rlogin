...
public class DesUtil {
	...
	public static final String encode(String strIn) throws Exception {
		return getInstance().encrypt(strIn);
	}

	public static final String decode(String arrB) throws Exception {
		return new String(getInstance().decrypt(arrB));
	}
	...
	public static Integer getIdFromEid(String eid) {
		try {
			return Integer.valueOf(DesUtil.getInstance().decrypt(eid));
		} catch (Exception e) {
			System.out.println("EID解密出错");
			return null;
		}
	}
}
